...
image = Image.open(r'C:\Users\AViey\OneDrive\Pictures\Customer-Analysis-1.jpg')
...
if st.button('Our Dataset'):
    ...
    image1 = Image.open(r"C:\Users\AViey\OneDrive\Pictures\MarketCampaignPic.PNG")
...
df = pd.read_csv(r"C:\Users\AViey\OneDrive\Documents\College\UCI\Math 10 intro to data analysis\datasets\marketing_campaign1.txt",
                 sep='\t')
df = df.iloc[:,3:20]
